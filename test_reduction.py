...
from noisereduce.generate_noise import int16_to_float32, float32_to_int16
...
def test_reduce_cafe_noise():
	...
	# reduce noise
	reduced_noise = nr.reduce_noise(audio_clip=audio_clip_cafe, noise_clip=noise_clip, verbose=True)
